...
ok("v15. SW含memberRoles与v16e3", swText.includes("memberRoles.js") && swText.includes("fuxun-planet-v16e3"));
...
ok("v16e3. App版本v16-E3", version.APP_VERSION === "v16-E3");
ok("v16e3. SW与version同步", version.SW_CACHE_ID === "fuxun-planet-v16e3" && swText.includes('const CACHE_NAME = "fuxun-planet-v16e3"'));
ok("v16e. SW含aiReferenceAnswer", swText.includes("aiReferenceAnswer.js"));
ok("v16e3. manifest启动参数", manifestText.includes('"start_url": "./?v=16e3"'));
